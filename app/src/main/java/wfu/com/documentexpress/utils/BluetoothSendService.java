...
public class BluetoothSendService {
    ...
    private FileUpdateAdapter transFile;
...
//        mHandler.sendMessage(msg);
        ...
        BluetoothSendService.this.start();
    }
...
//        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            mmSocket = socket;
             bluetoothCommunSocket=new BluetoothCommunSocket(handler,mmSocket);

        }

        public void run() {
            bluetoothCommunSocket.write(file);
